...
public class Trader implements Observer{
	...
	public void notifyUpdates(StockPurchase invoice, Trader trader , String type, String stockName) {
		System.out.format("%s %s  : ", this.getFirstName() , this.getLastName());
		System.out.format("%s %s %s %s stock at %s price!!\n", trader.getFirstName() , trader.getLastName(), type, stockName, invoice.getStockPrice()); 
	}
